window.addEventListener('load', ()=> {
    const API_ID = 'b59ed6c0976e0eb55bb512a88e29c4fb';
    let lon
    let lat
       ...
       navigator.geolocation.getCurrentPosition( posicion => {
           ...
           fetch(url)
            ...
            .then( data => {
                ...
                //console.log(temp)
                temperaturaValor.textContent = `${tempC} ° C`

                let temp2 = Math.round(data.main.feels_like)
                let tempC2 = Math.round(temp - 273.15)
                //console.log(temp)
                sensacionTermica.textContent = `${tempC2} ° C`
